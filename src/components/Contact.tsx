...
export function Contact() {
	return (
		...
		>
			{/* left */}
			<div className="flex place-items-center gap-2 h-14 p-3 bg-amber-100/10 hover:bg-amber-100 hover:text-neutral-900 rounded-3xl transition-all font-bold">
				© 2022 - ahmed.systems
			</div>

			{/* right */}
			<div className="flex gap-2 h-14 p-3 bg-amber-100/10 hover:bg-amber-100 hover:text-neutral-900 rounded-3xl transition-all">
